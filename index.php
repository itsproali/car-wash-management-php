            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <p><input type="text" name="fname" class="form-control" required placeholder="Full Name">
                        </p>
                        ...
                        <p><textarea name="message" class="form-control" placeholder="Message if any"></textarea>
                        </p>
